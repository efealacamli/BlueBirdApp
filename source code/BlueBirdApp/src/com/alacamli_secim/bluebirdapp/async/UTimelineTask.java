...
public class UTimelineTask extends AsyncTask<String, String, String> {

	private UTlineListener mEventHandler;
    private SharedPreferences mSharedPreferences;
    private TweetModel mModel;
	
    public UTimelineTask(SharedPreferences shrdPrfnc, TweetModel model){
		mSharedPreferences = shrdPrfnc;
		mModel = model;
    }
    
    public void setEventHandler(UTlineListener mListener){
